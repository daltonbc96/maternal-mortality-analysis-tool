...
BarPlotServer <- function(id, db_selected_country, column_firstLevel, column_secondLevel, targetVar, timeVar, groupVar) {
  moduleServer(id, function(input, output, session) {
    ...
    output$barPlot <- renderPlotly({
      plot <-  createGroupSocioBarPlot(processedDataNational = processedDataNacional(),
